...
-- 9: Get the cities that have a population below 1000
SELECT * FROM city WHERE population < 1000;

-- 10: Get the unique countrycodes from the cities that have a population below 1000
SELECT DISTINCT countrycode FROM city WHERE population < 1000;

-- 11: Get the cities with the countrycode UKR that has more than 1000000 in population
SELECT * FROM city WHERE countrycode = 'UKR' AND population > 1000000;

-- 12: Get the cities with a population of below 200 or above 9500000
...
-- 17: Get the countries that have no recorded independence year and a population above 1000000
